...
function Module() {
    ...
    const modalOpen =(num)=>{
        ...
        document.querySelector(`#btn${num}`).classList.add(`module3__body__main__${type}__wrapper__active`)
    }
                ...
                <div className="module3__body__main">
                    ...
                    <div className="module3__body__main__buttons">
                        ...
                        <div className="module3__body__main__buttons__wrapper">
                            <button onClick={()=>modalOpen(1)} id="btn1" className="module3__body__main__buttons__wrapper__1"><p>Tell me/us a bit about yourself</p></button>
                            <button onClick={()=>modalOpen(2)} id="btn2" className="module3__body__main__buttons__wrapper__2"><p>Why did you apply for this job?</p></button>
                            <button onClick={()=>modalOpen(3)} id="btn3" className="module3__body__main__buttons__wrapper__3"><p>What do you know about our organisation?</p></button>
                        </div>
                    ...
                    <div className="module3__body__main__star">
                        ...
                        <div className="module3__body__main__star__wrapper">
                            <button onClick={()=>modalOpen(4)} id="btn4" className="module3__body__main__star__wrapper__1">Situation</button>
                            <button onClick={()=>modalOpen(5)} id="btn5" className="module3__body__main__star__wrapper__2">Task</button>
                            <button onClick={()=>modalOpen(6)} id="btn6" className="module3__body__main__star__wrapper__3">Action</button>
                            <button onClick={()=>modalOpen(7)} id="btn7" className="module3__body__main__star__wrapper__4">Result</button>
                        </div>
                        <div className="module3__body__main__star__modal">
                            {
                                btnVal === 0?
                                <>
                                </>
                    ...
                    <div className="module3__body__main__mistake">
                        ...
                        <div className="module3__body__main__mistake__wrapper">
                            <button onClick={()=>modalOpen(8)} id="btn8" className="module3__body__main__mistake__wrapper__1">Too General</button>
                            <button onClick={()=>modalOpen(9)} id="btn9" className="module3__body__main__mistake__wrapper__2">Team Focus </button>
                            <button onClick={()=>modalOpen(10)} id="btn10" className="module3__body__main__mistake__wrapper__3">Job Focus</button>
                        </div>
                        <div className="module3__body__main__mistake__modal">
                            {
                                btnVal === 0?
                                <>
                                </>
                    ...
                    <div className="module3__body__main__card">
                    ...
                    <div className="module3__body__main__strength">
                    ...
                    <div className="module3__body__main__list">
                    ...
                    <div className="module3__body__main__mistake">
                        ...
                        <div className="module3__body__main__mistake__wrapper">
                            <button onClick={()=>modalOpen(11)} id="btn11" className="module3__body__main__mistake__wrapper__1">Strength</button>
                            <button onClick={()=>modalOpen(12)} id="btn12" className="module3__body__main__mistake__wrapper__2">Enthusiasm</button>
                            <button onClick={()=>modalOpen(13)} id="btn13" className="module3__body__main__mistake__wrapper__3">Examples</button>
                        </div>
                        <div className="module3__body__main__mistake__modal">
                            {
                                btnVal === 0?
