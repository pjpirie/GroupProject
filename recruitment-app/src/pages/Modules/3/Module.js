...
function Module() {
    ...
    const modalOpen =(num)=>{
        if(document.querySelector(`.module3-2__body__main__do__wrapper__do__active`)){document.querySelector(`.module3-2__body__main__do__wrapper__do__active`).classList.remove(`module3-2__body__main__do__wrapper__do__active`)}
        if(document.querySelector(`.module3-2__body__main__do__wrapper__dont__active`)){document.querySelector(`.module3-2__body__main__do__wrapper__dont__active`).classList.remove(`module3-2__body__main__do__wrapper__dont__active`)}
        btnClick(num)
        let type = 'buttons'
        console.log(num)
        ...
        if(num===16||num===17){
            type='do'
            if(num===16){return document.querySelector(`.module3-2__body__main__do__wrapper__do`).classList.add(`module3-2__body__main__do__wrapper__do__active`)}
            if(num===17){return document.querySelector(`.module3-2__body__main__do__wrapper__dont`).classList.add(`module3-2__body__main__do__wrapper__dont__active`)}
            document.querySelector(`.module3-2__body__main__do__wrapper__do`).classList.add(`module3-2__body__main__do__wrapper__do__active`)
            document.querySelector(`.module3-2__body__main__do__wrapper__dont`).classList.add(`module3-2__body__main__do__wrapper__dont__active`)
        }
        let active = document.querySelector(`.module3-2__body__main__${type}__wrapper__active`)
        if(active){
            active.classList.remove(`module3-2__body__main__${type}__wrapper__active`)
        }
        document.querySelector(`#btn${num}`).classList.add(`module3-2__body__main__${type}__wrapper__active`)
    }
    ...
    const modalClose=()=>{
        ...
        if(document.querySelector(`.module3-2__body__main__do__wrapper__do__active`)){document.querySelector(`.module3-2__body__main__do__wrapper__do__active`).classList.remove(`module3-2__body__main__do__wrapper__do__active`)}
        if(document.querySelector(`.module3-2__body__main__do__wrapper__dont__active`)){document.querySelector(`.module3-2__body__main__do__wrapper__dont__active`).classList.remove(`module3-2__body__main__do__wrapper__dont__active`)}
        if(document.querySelector('.module3-2__body__main__buttons__wrapper__active')){document.querySelector('.module3-2__body__main__buttons__wrapper__active').classList.remove('module3-2__body__main__buttons__wrapper__active')}
        if(document.querySelector('.module3-2__body__main__do__wrapper__active')){document.querySelector('.module3-2__body__main__do__wrapper__active').classList.remove('module3-2__body__main__do__wrapper__active')}
    }

    return (
        <div className="module3-2">
            <RSDPModuleLogo />
            <div className="module3-2__header">
                <div className="module3-2__header__text">
                    <h3>MODULE TWO</h3>
                    <h1>Face to Face Interview</h1>
                </div>
                <Eta time={10} />
            </div>
            <div className="module3-2__body">
                <div className="module3-2__body__video">
                    <video id="Video" autoplay controls>
                        <source src="https://rsdp-backend.herokuapp.com/video/2" type="video/mp4"></source>
                    </video>
                </div>
                <div className="module3-2__body__main">
                    <p className="module3-2__body__main__p">Interviews can be a daunting and nerve-racking experience but you can prepare to succeed with the tips and techniques within this module. Learn all about the three styles of questions you may experience at your next interview and start preparing your answers today.</p>
                    <div className="module3-2__body__main__text">
                        <div className="module3-2__body__main__text__left">
                            <h3>Follow the tips and techniques below to succeed at interview</h3>
                        </div>
                        <div className= "module3-2__body__main__text__right">
                    ...
                    <div className="module3-2__body__main__consider">
                        <h1>10 Tips</h1>
                    ...
                    <div className="module3-2__body__main__buttons">
                        ...
                        <div className="module3-2__body__main__buttons__wrapper">
                            <button onClick={()=>modalOpen(1)} id="btn1" className="module3-2__body__main__buttons__wrapper__1"><p>Tell me/us a bit about yourself</p></button>
                            <button onClick={()=>modalOpen(2)} id="btn2" className="module3-2__body__main__buttons__wrapper__2"><p>Why did you apply for this job?</p></button>
                            <button onClick={()=>modalOpen(3)} id="btn3" className="module3-2__body__main__buttons__wrapper__3"><p>What do you know about our organisation?</p></button>
                        </div>
                        <div className="module3-2__body__main__buttons__modal">
                            {
                                btnVal === 0?
                                <>
                                </>
                            ...
                            {
                                btnVal === 1?
                                    <div className="module3-2__body__main__buttons__modal__show">
                    ...
                    <div className="module3-2__body__main__questions">
                        ...
                        <div className="module3-2__body__main__questions__box">
                    ...
                    <div className="module3-2__body__main__star">
                        ...
                        <div className="module3-2__body__main__star__wrapper">
                            <button onClick={()=>modalOpen(4)} id="btn4" className="module3-2__body__main__star__wrapper__1">Situation</button>
                            <button onClick={()=>modalOpen(5)} id="btn5" className="module3-2__body__main__star__wrapper__2">Task</button>
                            <button onClick={()=>modalOpen(6)} id="btn6" className="module3-2__body__main__star__wrapper__3">Action</button>
                            <button onClick={()=>modalOpen(7)} id="btn7" className="module3-2__body__main__star__wrapper__4">Result</button>
                        </div>
                        <div className="module3-2__body__main__star__modal">
                            {
                                btnVal === 0?
                                <>
                                </>
                            ...
                            {
                                btnVal === 4?
                                    <div className="module3-2__body__main__star__modal__show">   
                                        <img src={CloseButtonImage} alt="Close" className="close__btn" onClick={modalClose}/>
                                        <h1>Situation</h1>
                    ...
                    <div className="module3-2__body__main__mistake">
                        ...
                        <div className="module3-2__body__main__mistake__wrapper">
                            <button onClick={()=>modalOpen(8)} id="btn8" className="module3-2__body__main__mistake__wrapper__1">Too General</button>
                            <button onClick={()=>modalOpen(9)} id="btn9" className="module3-2__body__main__mistake__wrapper__2">Team Focus </button>
                            <button onClick={()=>modalOpen(10)} id="btn10" className="module3-2__body__main__mistake__wrapper__3">Job Focus</button>
                        </div>
                        <div className="module3-2__body__main__mistake__modal">
                            {
                                btnVal === 0?
                                <>
                                </>
                            ...
                            {
                                btnVal === 8?
                                <div className="module3-2__body__main__mistake__modal__show">   
                                        <img src={CloseButtonImage} alt="Close" className="close__btn" onClick={modalClose}/>
                                        <h1>Too General</h1>
                    ...
                    <div className="module3-2__body__main__card">
                    ...
                    <div className="module3-2__body__main__strength">
                        ...
                        <div className="module3-2__body__main__strength__box">
                    ...
                    <div className="module3-2__body__main__list">
                    ...
                    <div className="module3-2__body__main__mistake">
                        ...
                        <div className="module3-2__body__main__mistake__wrapper">
                            <button onClick={()=>modalOpen(11)} id="btn11" className="module3-2__body__main__mistake__wrapper__1">Strength</button>
                            <button onClick={()=>modalOpen(12)} id="btn12" className="module3-2__body__main__mistake__wrapper__2">Enthusiasm</button>
                            <button onClick={()=>modalOpen(13)} id="btn13" className="module3-2__body__main__mistake__wrapper__3">Examples</button>
                        </div>
                        <div className="module3-2__body__main__mistake__modal">
                            {
                                btnVal === 0?
                    ...
                    <div className="module3-2__body__main__buttons">
                        ...
                        <div className="module3-2__body__main__buttons__wrapper">
                            <button onClick={()=>modalOpen(14)} id="btn14" className="module3-2__body__main__buttons__wrapper__1"><p>What are you particularly good at?</p></button>
                            <button onClick={()=>modalOpen(15)} id="btn15" className="module3-2__body__main__buttons__wrapper__2__1"><p>How good are you at working a tight deadline?</p></button>
                        </div>
                        <div className="module3-2__body__main__buttons__modal">
                            {
                                btnVal === 0?
                    ...
                    <div className="module3-2__body__main__do">
                        <h1>Enthusiasm - The Dos and Don’ts</h1>
                        <div className="module3-2__body__main__do__wrapper">
                            <button onClick={()=>modalOpen(16)} id="btn16" className="module3-2__body__main__do__wrapper__do"><p className="module3-2__body__main__do__wrapper__do__p">DO</p></button>
                            <button onClick={()=>modalOpen(17)} id="btn17" className="module3-2__body__main__do__wrapper__dont"><p className="module3-2__body__main__do__wrapper__dont__p">DON'T</p></button>
                        </div>
                        <div className="module3-2__body__main__do__modal">
                            {
                                btnVal === 0?
                                <>
                                </>
                            ...
                            {
                                btnVal === 16?
                                    <div className="module3-2__body__main__do__modal__show">   
                ...
                <div className="module3-2__body__main__download">
