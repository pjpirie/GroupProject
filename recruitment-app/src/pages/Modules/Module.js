        ...
        <div className="module">
            <div className="module__head">
                <div className="module__head__left">
                    ...
                    <h3 className="module__head__left__h3">The first step is achieving your goals.</h3>
                </div>
                <div className="module__head__right">
                    <img src={Laptop} alt="alt tag" className="module__head__right__img" />
                </div>
            </div>
            <div className="module__body">
                <div className="module__body__banner">
                    <img src={Room} alt="Room" className="module__body__banner__img" />
                    <div className="module__body__banner__shape">
                        <p className="module__body__banner__shape__text">Our Recruitment Skills Development Programme is the product of repeated exposure to candidates who have under- performed due to the absence of recruitment skills, techniques and targeted preparation. This Programme is designed to provide a straightforward means to enhance your chances of success by applying relevant learning in a structure focused on your specific situation.</p>
                    </div>
                </div>
                <div className="module__body__modules">
                    <h1>Prepare to Succeed <span> <br />with these Modules</span></h1>
                    <div className="module__body__modules__list">
                        <div className="module__body__modules__list__first">
                            <div className="module__body__modules__list__first__left">
                                <h3>MODULE ONE</h3>
                                <h2>Preparation</h2>
                            ...
                            <div className="module__body__modules__list__first__right">
                        ...
                        <div className="module__body__modules__list__second">
                            ...
                            <div className="module__body__modules__list__second__right">
                                <h3>MODULE TWO</h3>
                    ...
                    <div className="module__body__modules__quote">
                        <div className="module__body__modules__quote__mark" />
                    ...
                    <div className="module__body__modules__bottom">
